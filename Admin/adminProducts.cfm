...
<html>
    ...
    <body>
        ...
        <cfset variables.ProductListing=application.objShoppingCart.fnSelectSingleProduct(subcategoryId=url.subcategoryId)>
        ...
        <div class="modal fade" id="modalImageShow" tabindex="-1" aria-labelledby="static" data-bs-backdrop="static" aria-hidden="true">
        ...
        <div class="modal fade" id="modalAddProducts" tabindex="-1" aria-labelledby="static" data-bs-backdrop="static" aria-hidden="true">
            <div class="modal-dialog">
                    ...
                    <div class="modal-content  modalAddProducts d-flex  flex-column justify-content-between px-3 pt-4">
                        <div class="modalInputProducts">
                            ...
                            <div class="modalAddProductsBody">
                                ...
                                <input type="file" class="productImage mt-2 w-100" name="productImages" id="productImages" accept="image/png, image/jpg, image/jpeg, image/webp" multiple><br>
                        ...
                        <div class="modal-footer">
                            <cfoutput>
                                ...
                                <button type="button" class="btnAddProducts p-2" onclick="fnProductModalValidation()" id="btnAddProducts">Add Product</button>
                            </cfoutput>
                        </div>
                    </div>
                </form>
